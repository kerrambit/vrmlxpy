...
namespace vrml_proc {
    namespace parser {
        ...
        struct Vec4fGrammar
            : public boost::spirit::qi::grammar<Iterator, Vec4f(), Skipper>,
            public BaseGrammar <Iterator, Vec4f(), Skipper> {

            Vec4fGrammar() : Vec4fGrammar::base_type(this->m_start) {
                this->m_start = boost::spirit::qi::float_ >> boost::spirit::qi::float_ >> boost::spirit::qi::float_ >> boost::spirit::qi::float_;
