...
namespace to_stl::conversion_context {
  ...
  inline vrml_proc::action::ConversionContextActionMap<to_stl::conversion_context::MeshTaskConversionContext>&
  CreateActionMap() {
    static vrml_proc::action::ConversionContextActionMap<to_stl::conversion_context::MeshTaskConversionContext>
        actionMap;
    ...
    actionMap.AddAction(
        "Box", [](const vrml_proc::action::ConversionContextActionMap<
                      to_stl::conversion_context::MeshTaskConversionContext>::ReferencedArguments& refArgs,

                  const vrml_proc::action::ConversionContextActionMap<
                      to_stl::conversion_context::MeshTaskConversionContext>::CopiedArguments& copyArgs) {
          if (refArgs.size() == 1 &&
            ...
            return std::make_shared<to_stl::action::BoxAction>(
                to_stl::action::BoxAction::Properties{
    ...
    actionMap.AddAction(
        "Group", [](const vrml_proc::action::ConversionContextActionMap<
          ...
          if (refArgs.size() == 2 &&
              ...
              copyArgs.size() == 1 &&
              copyArgs[0].type() ==
                  typeid(std::vector<std::shared_ptr<to_stl::conversion_context::MeshTaskConversionContext>>)) {
            auto children =
                std::any_cast<std::vector<std::shared_ptr<to_stl::conversion_context::MeshTaskConversionContext>>>(
                    copyArgs[0]);
    ...
    actionMap.AddAction(
        "Transform", [](const vrml_proc::action::ConversionContextActionMap<
          ...
          if (refArgs.size() == 7 &&
            ...
            return std::make_shared<to_stl::action::TransformAction>(properties);
          }
    ...
    actionMap.AddAction(
        "Switch", [](const vrml_proc::action::ConversionContextActionMap<
          ...
          if (refArgs.size() == 0 && copyArgs.size() == 1 &&
            ...
            return std::make_shared<to_stl::action::SwitchAction>(properties);
          }
        ...
        "Shape", [](const vrml_proc::action::ConversionContextActionMap<
          ...
          if (refArgs.size() == 0 && copyArgs.size() == 2 &&
            ...
            auto appearance =
                std::any_cast<std::shared_ptr<to_stl::conversion_context::MeshTaskConversionContext>>(copyArgs[0]);
            auto geometry =
                std::any_cast<std::shared_ptr<to_stl::conversion_context::MeshTaskConversionContext>>(copyArgs[1]);
                        ...
                        [](const vrml_proc::action::ConversionContextActionMap<
                          ...
                          if (refArgs.size() == 14 && copyArgs.size() == 2 && copyArgs[0].type() == typeid(bool) &&
                            ...
                            return std::make_shared<to_stl::action::IndexedFaceSetAction>(
                                properties, to_stl::action::GeometryAction::Properties{
                                                std::any_cast<bool>(copyArgs[0]),
                                                std::any_cast<vrml_proc::math::TransformationMatrix>(copyArgs[1])});
                          }
