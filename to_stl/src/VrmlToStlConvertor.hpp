...
namespace to_stl::VrmlToStlConvertor {
	...
	inline VRMLTOSTL_API cpp::result<std::shared_ptr<to_stl::core::Mesh>, std::shared_ptr<vrml_proc::core::error::Error>> Convert(vrml_proc::parser::BufferView dataToProcess) {

		auto processingResult = vrml_proc::VrmlProcessor::Process<to_stl::conversion_context::MeshTaskConversionContext>(dataToProcess, to_stl::conversion_context::CreateActionMap());
