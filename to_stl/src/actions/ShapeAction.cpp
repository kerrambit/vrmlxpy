...
namespace to_stl {
  namespace action {
    ...
    ShapeAction::ShapeAction(std::shared_ptr<to_stl::conversion_context::MeshTaskConversionContext> appearance,
                             std::shared_ptr<to_stl::conversion_context::MeshTaskConversionContext> geometry)
