...
namespace vrml_proc {
  namespace action {
    ...
    template <typename ConversionContext>
    std::shared_ptr<ConversionContextAction<ConversionContext>>
    ConversionContextActionMap<ConversionContext>::GetAction(const std::string& key, const ReferencedArguments& refArgs,
