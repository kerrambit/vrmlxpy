...
namespace vrml_proc::traversor::node_descriptor {
	...
	public:
		...
		cpp::result<void, std::shared_ptr<vrml_proc::traversor::validator::error::NodeValidationError>> Validate(const vrml_proc::parser::VrmlNode& node, const vrml_proc::parser::VrmlNodeManager& manager, bool checkName = false) {
			...
			for (const auto& field : node.fields) {
				...
				{
					auto boolean = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<bool>(field.name, node.fields);
				...
				{
					auto string = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<std::string>(field.name, node.fields);
					if (string.has_error()) {
				...
				{
					auto float32_t = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<vrml_proc::parser::float32_t>(field.name, node.fields);
				...
				{
					auto int32 = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<int32_t>(field.name, node.fields);
					if (int32.has_error()) {
				...
				{
					auto vec2f = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<vrml_proc::parser::Vec2f>(field.name, node.fields);
					if (vec2f.has_error()) {
				...
				{
					auto vec4f = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<vrml_proc::parser::Vec4f>(field.name, node.fields);
					if (vec4f.has_error()) {
				...
				{
					auto value = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<vrml_proc::parser::Vec2fArray>(field.name, node.fields);
					if (value.has_error()) {
				...
				{
					auto value = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<vrml_proc::parser::Vec3fArray>(field.name, node.fields);
					if (value.has_error()) {
						return cpp::fail(value.error());
					}
				...
				{
					auto value = vrml_proc::traversor::validator::NodeValidator::ExtractFieldByNameWithValidation<vrml_proc::parser::Int32Array>(field.name, node.fields);
					if (value.has_error()) {
						return cpp::fail(value.error());
					}
	...
	private:
		...
		std::map<std::string, std::optional<std::reference_wrapper<const vrml_proc::parser::Vec2fArray>>> m_vec2fArrayFields;
		std::map<std::string, std::optional<std::reference_wrapper<const vrml_proc::parser::Vec3fArray>>> m_vec3fArrayFields;
		std::map<std::string, std::optional<std::reference_wrapper<const vrml_proc::parser::Int32Array>>> m_int32ArrayFields;
