...
namespace vrml_proc::traversor::node_descriptor {
    ...
    inline NodeDescriptorMap CreateNodeDescriptorMap() {
        ...
        nodeDescriptionMap["Shape"] = []() {
            ...
            nd.BindVrmlNode("geometry", { "Box", "VRMLBox", "Cone", "VRMLCone", "Cylinder", "VRMLCylinder", "ElevationGrid", "VRMLElevationGrid", "Extrusion", "VRMLExtrusion", "IndexedFaceSet", "VRMLIndexedFaceSet", "IndexedLineSet", "VRMLIndexedLineSet", "PointSet", "VRMLPointSet", "Sphere", "VRMLSphere", "Text", "VRMLText" }, defaultGeometry); // TODO: fucntion will take set of names
