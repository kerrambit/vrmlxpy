...
BOOST_FUSION_ADAPT_STRUCT(vrml_proc::parser::Vec3f,
                          (vrml_proc::parser::float32_t, x)(vrml_proc::parser::float32_t,
                                                            y)(vrml_proc::parser::float32_t, z))
    ...
    struct Vec3fGrammar : public boost::spirit::qi::grammar<Iterator, Vec3f(), Skipper>,
     ...
     public:
      Vec3fGrammar() : Vec3fGrammar::base_type(this->m_start) {
        ...
        this->m_start = float32 >> float32 >> float32;  // '>' will trigger error, '>>' won't
        ...
        /*boost::spirit::qi::on_error<boost::spirit::qi::fail>(
            ...
            << boost::phoenix::bind(&Vec3fGrammar::ConstructErrorPositionString, this, boost::spirit::qi::_1,
        boost::spirit::qi::_3, boost::spirit::qi::_2, boost::spirit::qi::_4, 16)
            << std::endl
        );*/
      }

      std::string ConstructErrorPositionString(const Iterator& begin, const Iterator& errorPosition,
                                               const Iterator& end, const boost::spirit::info& expectedRule,
                                               size_t maxLength) {
        /**
