...
namespace vrml_proc {
    namespace parser {
        ...
        struct VrmlNode;
        using VrmlFieldValue = boost::variant<std::string, bool, Vec3fArray, Vec2fArray, Int32Array, float32_t, int32_t, Vec4f, Vec3f, Vec2f, UseNode, boost::recursive_wrapper<struct VrmlNode>, std::vector<boost::variant<boost::recursive_wrapper<struct VrmlNode>, boost::recursive_wrapper<struct UseNode>>>>;
