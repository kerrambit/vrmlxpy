...
vrml_proc::core::io::FileReader<std::string>::LoadFileResult vrml_proc::core::io::SimpleFileReader::Read(
  ...
  LogInfo(FormatString("Time to read and load file <", filepath.string(), "> of size ", fileSize,
